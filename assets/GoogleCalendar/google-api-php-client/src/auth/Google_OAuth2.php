...
require_once(dirname(dirname(__FILE__))."/service/Google_Utils.php");
...
class Google_OAuth2 extends Google_Auth {
  ...
  public function createAuthUrl($scope) {
    ...
    // to auth URL
    if(strpos($scope, 'plus.login') && count((array)$this->requestVisibleActions) > 0) {
